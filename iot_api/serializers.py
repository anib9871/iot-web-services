...
from .models import (
    ...
    DeviceAlarmCallLog, DeviceAlarmLog, MasterUOM,MasterCentre, MasterRole , CentreOrganizationLink, MasterUser, UserOrganizationCentreLink,MasterNotificationTime
)
...
class MasterDeviceSerializer(serializers.ModelSerializer):
    class Meta:
        model = MasterDevice
        fields = ['DEVICE_ID', 'DEVICE_NAME','ORGANIZATION_ID','CENTRE_ID']
...
class MasterNotificationTimeSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['NOTIFICATION_TIME','ORGANIZATION_ID']
